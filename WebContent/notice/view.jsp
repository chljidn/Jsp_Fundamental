	        ...
	        <div class="col-md-12">
	        	...
	        	<form method="post" name="f" action="">
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="writer" name="writer" value="writer" value="<%=writer %>" placeholder="작성자를 입력해주세요">
				  </div>
				  <div class="form-group">
				    <label for="title">제목</label>
				    <input type="text" class="form-control" id="title" name="title" value="타이틀" value="<%=title %>" placeholder="제목을 입력해주세요">
				  </div>
				  <div class="form-group">
